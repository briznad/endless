...
break;case"swipeRight":g("left");break;case"swipeUp":g("down");break;case"swipeDown":g("up");break;}});},d=function(){n.tapTarget.on("tap",function(o){g(e(this).data("slideDir"));
});},b=function(){n.body.on("keydown",function(o){switch(o.which){case 37:g("left");break;case 38:g("up");break;case 39:g("right");break;case 40:g("down");
break;}});},g=function(p){function q(){n.grid.scrollTo(".row-"+h.row+" > .col-"+h.col,750,{easing:"easeOutExpo"});}function o(){n.grid.scrollTo(".row-"+h.row+" > .col-"+h.col,3000,{easing:"easeInOutBack"});
...
},f=function(){var o="";_(11).times(function(q){var p=q+1;o+='<div class="frame-row row-'+p+'">';_(11).times(function(t){var s=t+1,r=a();o+='<img class="frame-col col-'+s+'" src="assets/images/frames/'+r+'" alt="'+r.split(".")[0].replace("_"," ")+'" />';
});o+="</div>";a();});e(".frame-container").html(o);n.body=e("body");n.grid=e(".visible-frame");_(11).times(function(q){var p=q+1;n.row[p]=n.grid.find(".row-"+p);
n.col[p]=n.grid.find(".col-"+p);});n.loadingOverlay=e(".loading-overlay");n.tapTarget=e(".tap-target");n.tapTargetContainer=n.tapTarget.parent();e(window).on("orientationchange resize",function(p){c();
});m();d();b();c();j();e(window).load(function(){i();n.body.addClass("delayed");n.grid.scrollTo(".row-6 > .col-6");var p=setTimeout(function(){n.loadingOverlay.fadeOut(1000);
},250);});},k=0,i=function(){var o=new Image();o.src="assets/images/frames/"+l[k];o.onload=function(){k++;if(k<l.length){i();}};};e(function(){f();});})(jQuery);
